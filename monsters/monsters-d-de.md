...
it never hesitates to attack when it deems a battle necessary—or likely
to end in its victory.
...
In its natural form, an imp stands almost 2 feet tall and weighs about 8
pounds.
...
invisibility* (self only); 1/day—*suggestion* (DC 15). Caster level 6th.
The save DC is Charisma-based.
...
A pit fiend often wraps its wings around itself like a grotesque cloak,
